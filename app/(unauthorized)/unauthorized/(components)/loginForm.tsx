                        ...
                        <div className="relative -space-y-px rounded-md shadow-sm">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    autoComplete="email"
                                    required
                                    className="relative block w-full rounded-t-md border-0 pl-1 py-1.5 text-gray-900 ring-1 ring-inset ring-gray-100 placeholder:text-gray-400 focus:z-10 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    required
                                    className="relative block w-full rounded-b-md border-0 pl-1 py-1.5 text-gray-900 ring-1 ring-inset ring-gray-100 placeholder:text-gray-400 focus:z-10 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                                    placeholder="Heslo"
