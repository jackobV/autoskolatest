                    ...
                    <div className="-mt-2 p-2 lg:mt-0 lg:w-full lg:max-w-md lg:flex-shrink-0">
                        <div className="pb-2">
                            <div className="text-gray-300 text-sm flex-col flex md:flex-row md:items-center gap-x-1">
                                <div className="flex flex-row items-center gap-x-1">
                                    ...
                                    <p className="text-green-500">CZK 100 sleva</p>
                                </div>
                        ...
                        <div
                            ...
                            <div className="mx-auto max-w-xs px-8">
                                <p className="text-base font-semibold text-gray-300">Měsíční Premium předplatné</p>
                                <p className="mt-6 flex items-baseline justify-center gap-x-2">
                                    <span className="line-through text-gray-400">199</span>
                                    <span className="text-5xl font-bold tracking-tight text-gray-100">99</span>
                                    <span className="font-semibold leading-6 tracking-wide text-gray-500">Kč</span>
                                </p>
                                <a
                                    href="/registrace"
